...
<!-- START_PROJECT_INTRO -->
AI-RSS 自动聚合全球主流 AI 官方 RSS 源，涵盖模型、论文与产品的最新动态。项目通过 GitHub Actions 每 3 小时自动更新，并以静态 index.html 页面和 README 摘要形式展示内容，方便用户快速浏览和追踪业界前沿进展。适合关注 PyTorch、Qwen、vLLM 等主流项目发布的研究者和开发者使用。
<!-- END_PROJECT_INTRO -->

👉 **[🌐 点击这里进入专属独立阅读主页](https://tigercoll.github.io/AI-RSS/)**

⏳ 最后自动更新时间：2026/6/27 19:04:34
