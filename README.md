...
<!-- START_PROJECT_INTRO -->
AI-RSS 自动聚合全球主流 AI 官方 RSS 源，帮助用户高效追踪模型、论文及产品的最新动态。项目通过 GitHub Actions 每 3 小时自动更新，输出为静态 index.html 阅读页和 README 最新摘要，内容涵盖 Qwen、vLLM 等主流项目发布。适合希望快速了解 AI 领域前沿进展的开发者和研究者使用。
<!-- END_PROJECT_INTRO -->
