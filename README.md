...
<!-- START_PROJECT_INTRO -->
AI-RSS 自动聚合全球主流 AI 官方 RSS 源，帮助用户高效追踪模型、论文及产品的最新动态。项目通过 GitHub Actions 每 3 小时自动更新，输出为静态 index.html 阅读页和 README 最新摘要，内容涵盖 PyTorch、Qwen、vLLM 等主流项目发布。适合希望快速了解 AI 领域前沿进展的开发者和研究者使用。
<!-- END_PROJECT_INTRO -->

👉 **[🌐 点击这里进入专属独立阅读主页](https://tigercoll.github.io/AI-RSS/)**

⏳ 最后自动更新时间：2026/6/27 21:51:23
...
<!-- START_LIVE_FEEDS -->
### 📢 [PyTorch：Fix LoggingTestCase._handler_watcher to co...](https://github.com/pytorch/pytorch/releases/tag/trunk%2F35150dd94b31349f9f21dced59561d2bc5290374)
...
### 📢 [PyTorch：Make test_dataloader.py device-generic for...](https://github.com/pytorch/pytorch/releases/tag/viable%2Fstrict%2F1782556190)
**来源:** `PyTorch Releases` | **时间:** `2026/6/27 14:15:17`

> 💡 Make test_dataloader.py device-generic for pin_memory and mult…

---

### 📢 [PyTorch：Allow grads for attn_bias only](https://github.com/pytorch/pytorch/releases/tag/viable%2Fstrict%2F1782549636)
**来源:** `PyTorch Releases` | **时间:** `2026/6/27 12:37:12`

> 💡 Fixed a CUDA illegal memory access in torch.nn.functional.scaled_dot_product_attention when the float attention mask is the only input...

---

### 📢 [PyTorch：Revert "[dynamo, nested graph breaks] fix...](https://github.com/pytorch/pytorch/releases/tag/trunk%2F731a9d775a76a056ab09631a8785d39dde89465a)
...
### 📢 [Qwen Code：Full Changelog : v0.19.2...v0.19.2-nightly...](https://github.com/QwenLM/qwen-code/releases/tag/v0.19.2-nightly.20260627.d93bec905)
**来源:** `Qwen Code Releases` | **时间:** `2026/6/27 08:52:45`

> 💡 Release Release v0.19.2-nightly.20260627.d93bec905 · QwenLM/qwen-code · GitHub / /releases/show" data-turbo-transient="true" /> Skip to...

---

### 📢 [vLLM：Raise gsm8k startup timeout for MoE Refact...](https://github.com/vllm-project/vllm/releases/tag/v0.24.0)
**来源:** `vLLM Releases` | **时间:** `2026/6/27 07:33:47`

> 💡 Raise gsm8k startup timeout for MoE Refactor Qwen3 NVFP4 configs…

---

### 📢 [Ollama v0.30.11发布：新增自动安装和显卡检测功能](https://github.com/ollama/ollama/releases/tag/v0.30.11)
...
### 📢 [Qwen Code：cua-driver prebuilt binaries — relative-co...](https://github.com/QwenLM/qwen-code/releases/tag/cua-driver-rs-v0.6.8)
**来源:** `Qwen Code Releases` | **时间:** `2026/6/26 21:35:37`

> 💡 cua-driver prebuilt binaries — relative-coordinate fork (vendored under packages/cua-driver ).
...
> 💡 点击标题查看《Previewing GPT-5.6 Sol: a next-generation model》原文。

---

### 📢 [Ollama v0.30.11-rc1增加Ornith 9B解析器支持](https://github.com/ollama/ollama/releases/tag/v0.30.11-rc1)
...
### 📢 [vLLM：Fix P/D with DP Supervisor](https://github.com/vllm-project/vllm/releases/tag/v0.24.0rc2)
...
> 💡 In this technical collaboration between AWS and the authors, we present a pragmatic solution: agentic overlays. Agentic overlays are thin wr...
...
* **Qwen Code Releases:** `https://github.com/QwenLM/qwen-code/releases.atom`
